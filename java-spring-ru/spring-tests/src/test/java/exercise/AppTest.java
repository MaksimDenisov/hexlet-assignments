...
public class AppTest {
    ...
    @Test
    void testUpdatePeopleById() throws Exception {
        MockHttpServletResponse response = mockMvc
                .perform(patch("/people/1")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"firstName\": \"firstNameUpdated\", \"lastName\": \"lastNameUpdated\"}"))
                .andReturn()
                .getResponse();
        ...
        assertThat(getResponse.getContentAsString()).contains("firstNameUpdated", "lastNameUpdated");
    }
